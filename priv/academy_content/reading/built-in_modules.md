...
<a style="display: flex; color: #61758a; margin-left: 1rem;" href="../exercises/book_search.livemd">Book Search</a>
</div>
<div style="display: flex;">
...
<details style="background-color: lightgreen; padding: 1rem; margin: 1rem 0;">
  ...
  An empty list technically counts as a keyword list, because it does not have any elements
