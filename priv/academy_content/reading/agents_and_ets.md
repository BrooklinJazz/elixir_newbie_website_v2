...
```
$ git checkout -b agents-and-ets-reading
$ git add .
$ git commit -m "finish agents and ets reading"
$ git push origin agents-and-ets-reading
```

Create a pull request from your `agents-and-ets-reading` branch to your `solutions` branch.
