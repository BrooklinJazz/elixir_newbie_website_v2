...
You should be able to use the `Assertion.assert` macro to display a failure message for the following assertions without raising a [FunctionClauseError](https://hexdocs.pm/elixir/FunctionClauseError.html).
