...
```
$ git checkout -b games-setup-exercise
$ git add .
$ git commit -m "finish games setup exercise"
$ git push origin games-setup-exercise
```

Create a pull request from your `games-setup-exercise` branch to your `solutions` branch.
...
| Previous                     | Next                                                            |
| ---------------------------- | --------------------------------------------------------------: |
| [Mix](../reading/mix.livemd) | [Games: Guessing Game](../exercises/games_guessing_game.livemd) |
