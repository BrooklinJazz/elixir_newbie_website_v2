...
```
$ git checkout -b games-benchmarking-exercise
$ git add .
$ git commit -m "finish games benchmarking exercise"
$ git push origin games-benchmarking-exercise
```

Create a pull request from your `games-benchmarking-exercise` branch to your `solutions` branch.
...
| Previous                                       | Next                                                          |
| ---------------------------------------------- | ------------------------------------------------------------: |
| [Benchmarking](../reading/benchmarking.livemd) | [Custom Enum](../exercises/custom_enum_with_recursion.livemd) |
