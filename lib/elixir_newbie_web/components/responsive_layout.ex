defmodule ElixirNewbieWeb.Components.ResponsiveLayout do
  ...
  attr(:spacing, :string, values: ["full", "narrow"], default: "narrow")
  attr(:gap, :string, values: ["none", "small", "large"], default: "small")
  ...
  def responsive_layout(assigns) do
    ...
    <section data-scroll-id={@scroll_id} class={[
      ...
      @cols === 3 && "grid lg:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 gap-12",
      @cols === 4 && "grid w-full min-h-full gap-12 sm:grid-cols-1 xl:grid-cols-4 lg:grid-cols-2"
    ]}>
