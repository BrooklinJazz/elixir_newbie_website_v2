defmodule ElixirNewbieWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirNewbieWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirNewbieWeb.Gettext, "errors", msg, opts)
    end
  end
