      ...
      <section class="flex h-fit w-full flex-col gap-12 4k:gap-36 lg:flex-row xl:gap-24 mx-auto sm:w-full md:w-3/4 lg:w-full xl:w-3/4">
        <article class="grid h-fit w-full grid-cols-6 grid-rows-6">
          ...
          <%!-- <.link
              ...
              class={"row-start-5 col-start-2 relative right-2 top-1/3 group animate-fade-in"}
            >
              <div class="transition duration-300 ease-in-out group-hover:scale-110">
                ...
                <img alt="Twitter Icon Button" class="rounded-full border-2" src="images/discord_icon.png"/>
                <p class="absolute -bottom-10 w-full text-center text-sm text-white transition duration-300 ease-in-out opacity-0 group-hover:opacity-100"> Join our Discord!</p>
              </div>
            </.link> --%>
            <%!-- <.link
            ...
            >
              <div class="transition duration-300 ease-in-out group-hover:scale-110">
                ...
                <p class="absolute -bottom-10 w-full text-center text-sm text-white transition duration-300 ease-in-out opacity-0 group-hover:opacity-100">Twitter</p>
              </div>
            </.link>
            <.link
            ...
            >
              <div class="transition duration-300 ease-in-out group-hover:scale-110">
                ...
                <p class="absolute -bottom-10 w-full text-center text-sm text-white transition duration-300 ease-in-out opacity-0 group-hover:opacity-100">GitHub</p>
              </div>
            </.link>
            <.link
            ...
            >
              <div class="transition duration-300 ease-in-out group-hover:scale-110">
                ...
                <p class="absolute -bottom-10 w-full text-center text-sm text-white transition duration-300 ease-in-out opacity-0 group-hover:opacity-100">Linkedin</p>
              </div>
            </.link>
            <.link
