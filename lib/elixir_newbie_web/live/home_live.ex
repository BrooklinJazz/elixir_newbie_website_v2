      ...
      <section class="mx-auto flex w-full flex-col gap-12 4k:mt-36 4k:w-1/2 4k:gap-36 sm:w-full md:w-3/4 lg:w-full lg:flex-row xl:w-3/4 xl:gap-24">
        <article class="animate-fade-in grid h-fit w-full grid-cols-6 grid-rows-6">
          <figure class="aspect-square relative col-start-1 col-end-6 row-start-1 row-end-6 overflow-hidden rounded-full border-t-4 border-l-4 border-white">
            ...
            <img class="h-full w-full" alt="home page icon of a wizard" src="images/HomeWizard.webp" />
          </figure>
          <%= if @ready_for_animations do %>
            <.round_link
              link="https://discord.gg/XBAAmuZGXU"
              position="row-start-5 col-start-2 relative right-2 top-1/3"
              logo="images/DiscordIcon.webp"
            >
              Elixir Newbie Discord
            </.round_link>
            <.round_link
              link="https://twitter.com/BrooklinJMyers"
              position="row-start-3 col-start-5 relative left-1/2 bottom-1/3"
              logo="images/TwitterIcon.webp"
            >
              Twitter
            </.round_link>
            <.round_link
              link="https://github.com/BrooklinJazz"
              position="relative col-start-5 relative left-1/3 sm:left-1/4 row-start-4"
              logo="images/GitHubIcon.webp"
            >
              GitHub
            </.round_link>
            <.round_link
              link="https://www.linkedin.com/in/brooklinmyers/"
              position="row-start-5 col-start-4 relative left-1/2"
              logo="images/LinkedinIcon.webp"
            >
              Linkedin
            </.round_link>
            <.round_link
              link="https://github.com/DockYard-Academy/beta_curriculum"
              position="row-start-5 col-start-3 relative left-1/4 top-1/2"
              logo="images/DockYardAcademyIcon.webp"
            >
              DockYard Academy
            </.round_link>
          <% end %>
        ...
        <article class="flex w-full flex-col text-2xl text-white 4k:text-4xl lg:text-2xl">
          <h1>
            Greetings, traveler, My name is Brooklin. I am here to teach you Elixir. Where should we start?
          </h1>
          <.rectangle_link navigate={~p"/blog"} src="images/BlogButton.webp" alt="Fantasy Book Shelf">
            1. Read the Blog
          </.rectangle_link>
          <.rectangle_link
            navigate={~p"/podcast"}
            src="images/PodcastButton.webp"
            alt="Fantasy Face In Flowers"
          >
            2. Listen to the Podcast
          </.rectangle_link>
          <.rectangle_link
            navigate={~p"/dockyard_academy"}
            src="images/DockYardAcademyButton.webp"
            alt="Fantasy Mushroom Forest"
          >
            3. Explore Learning Resources
          </.rectangle_link>
          <.rectangle_link
            navigate={~p"/discord"}
            src="images/DiscordButton.webp"
            alt="Fantasy Village"
          >
            4. Join our Discord
          </.rectangle_link>
