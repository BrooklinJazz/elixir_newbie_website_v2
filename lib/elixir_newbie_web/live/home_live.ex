    ...
    <section class="flex h-fit w-full flex-col gap-12 4k:gap-36 lg:flex-row xl:gap-24">
      <article class="grid h-fit w-full grid-cols-6 grid-rows-6">
        <img
          ...
          class="rounded-full border-t-4 border-l-4 border-white row-start-1 row-end-6 col-start-1 aspect-square col-end-6"
          src="images/home_page_icon_reduced.webp"
        />
        <.link
          href="https://twitter.com/BrooklinJMyers"
          class="row-start-3 col-start-5 relative left-1/2 bottom-1/3 sm:bottom-1/4"
        >
        ...
        <.link
          ...
          class="relative col-start-5 relative left-1/3 sm:left-1/4 row-start-4"
        >
        ...
        <.link
          ...
          class="row-start-5 col-start-4 relative left-1/2"
        >
        ...
        <.link
          ...
          class="row-start-5 col-start-3 relative left-1/4 top-1/2"
        >
      ...
      <article class="flex w-full flex-col text-white text-2xl lg:text-2xl 4k:text-4xl">
        <h1>Greetings, traveler, My name is Brooklin. I am here to teach you Elixir. Where should we start?</h1>
          <.link navigate={~p"/blog"} class={"mt-4 xl:mt-8 text-left relative"} >
            ...
            <img alt="Blog" src="images/blog_button_reduced.webp" class="rounded-3xl border-4 border-white aspect-[5/1]')]"/>
          </.link>
          <.link navigate={~p"/podcast"} class={"mt-4 xl:mt-8 text-left relative"} >
            ...
            <img alt="Blog" src="images/podcast_button_reduced.webp" class="rounded-3xl border-4 border-white aspect-[5/1]"/>
          </.link>
          <.link navigate={~p"/resources"} class={"mt-4 xl:mt-8 text-left relative"} >
            ...
            <img alt="Blog" src="images/resources_button_reduced.webp" class="rounded-3xl border-4 border-white aspect-[5/1]"/>
          </.link>
      </article>
    </section>
    """
