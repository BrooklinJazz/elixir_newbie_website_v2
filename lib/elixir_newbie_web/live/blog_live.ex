      ...
      <div class="to-black/40 bg-gradient-to-t from-black">
        ...
        <section class="mx-auto flex h-fit w-full flex-col gap-12 4k:gap-36 sm:w-full md:w-3/4 lg:w-full lg:flex-row xl:w-3/4 xl:gap-24">
          <div>
            ...
            <div class="grid grid-cols-5 gap-4 px-2">
              <.form
                ...
                phx-change="filter"
                phx-submit="scroll"
                phx-hook="ScrollOnSubmit"
                phx-data-value="all_blogs"
                class="col-span-4 grid h-fit w-full"
                autocomplete="off"
                for={%{}}
              >
                <div class="flex items-center rounded-xl rounded-full px-8 text-center text-sm font-semibold ring-2 ring-white transition duration-500 ease-in-out hover:ring-offset-2">
                  ...
                  <input
                    ...
                    id="search-blogs"
                    errors={[]}
                    class="h-8 w-0 flex-grow bg-transparent p-4 py-8 text-white placeholder-gray-400 outline-none focus-within:text-secondary"
                    value={@search}
                  />
              ...
              <.button
                id="see_results"
                phx-hook="ScrollOnClick"
                class="cursor-pointer rounded-xl rounded-full rounded-full bg-transparent text-center text-center text-sm font-semibold ring-2 ring-white transition duration-500 ease-in-out hover:bg-transparent hover:ring-offset-2"
                phx-data-value="all_blogs"
              >
          ...
          <article class="flex w-full flex-col px-2 text-2xl text-white 4k:text-4xl lg:text-2xl">
            <h1>
              Here, open my scroll. Don’t worry, it has a friendly and approachable tone. Plus it’s searchable...
            </h1>
