  ...
  def render(assigns) do
    ...
    <section class="sm:bg-[url('/images/DiscordBackground.png')] h-screen bg-cover min-h-screen text-white w-screen bg-no-repeat">
      <div class="from-black/90 to-black/25 h-screen w-full bg-gradient-to-t">
        <.navigation />
        <section class="p-8">
          <h1 class="mb-4 text-center text-2xl 4k:mb-16 4k:text-6xl 2xl:text-3xl">
            Let's Learn Together!
          </h1>
          <h2 class="mb-3 text-center text-xl 4k:mb-20 4k:text-3xl">
            Join the Elixir Newbie Discord. We run weekly group coding sessions.
            <br />Join us to learn Elixir in a hands-on, practical environment.
          </h2>
          <h2 class="mb-6 text-center text-sm text-xl 4k:mb-24 4k:text-4xl">
            Our next meeting is at <strong><%= next_saturday(Date.utc_today()) %></strong>
            at 9:30am PT
          </h2>
          <article class="flex items-center justify-center sm:space-x-12">
            ...
            <figure class="w-3/4 rounded-lg p-6 4k:w-1/5 sm:w-2/5 lg:w-1/4">
              <p class="text-xl 4k:text-3xl">
                We call it the hack-a-thing: every Saturday we get together, think something up, and code it.
              </p>
              <hr class="my-4" />
              <p class="text-xl 4k:text-3xl">
                This is a great opportunity for learning (no matter your level) and for meeting other Elixir enthusiasts.
              </p>
              <a
